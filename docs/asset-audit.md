...
- `public/assets/data/data.json`: 38 menu items, 38 pairings, 4 chefs, 17 screenshot references.
- `public/assets/data/asset-manifest.json`: 197 audited package assets.
- Total copied files in `public/assets`: 200 including data files.
- Duplicate menu IDs: none.
- Missing pairing references: none.
- Missing chef notes: none.
- Known standalone menu image fallback: `sushi-cone`, using `/assets/pairings/sushi-cone-senkin-modern-muku.webp`.
